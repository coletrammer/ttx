...
struct Capability {
    ...
    di::StringView short_name;                             ///< Short name stored in terminfo file
    di::Variant<di::Void, u32, di::StringView> value = {}; ///< Void means a boolean capabillity
...
struct Terminfo {
    di::Span<di::StringView const> names;
